...
ALTER TABLE blood_pressure_trends ADD COLUMN medication_adherence_pct DOUBLE PRECISION;
ALTER TABLE blood_pressure_trends ADD COLUMN avg_sodium_intake_mg DOUBLE PRECISION;
ALTER TABLE blood_pressure_trends ADD COLUMN avg_potassium_intake_mg DOUBLE PRECISION;
