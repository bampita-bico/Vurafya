...
INSERT INTO boss_encounters (id, boss_name, boss_title, description, condition_focus, base_hp, difficulty_level, respawn_days, min_level_required, requires_subscription_tier, xp_reward_base, ap_reward_base, icon, lore_text) VALUES
-- CKD Bosses
...
INSERT INTO boss_mechanics (boss_id, mechanic_type, target_metric, target_operator, target_value, required_days, damage_per_success, description, sequence_order) VALUES
...
INSERT INTO boss_loot_table (boss_id, loot_type, loot_value, loot_name, drop_chance_pct, is_first_kill_only, description) VALUES
...
INSERT INTO boss_condition_links (boss_id, condition_id, unlock_at_stage, hp_modifier, description) VALUES
-- CKD bosses
