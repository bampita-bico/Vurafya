...
ALTER TABLE pharmacy_orders ADD COLUMN labor_hours_committed DOUBLE PRECISION DEFAULT 0;
...
CREATE TABLE IF NOT EXISTS pharmacy_payment_acceptance (
  ...
  max_labor_hours_per_month DOUBLE PRECISION, -- Max labor hours pharmacy can use
  ...
  min_fiat_percentage DOUBLE PRECISION DEFAULT 30.0, -- Require at least 30% in fiat currency
...
CREATE TABLE IF NOT EXISTS facility_payment_acceptance (
  ...
  min_fiat_percentage DOUBLE PRECISION DEFAULT 20.0, -- Facilities more flexible (20% min fiat)
...
INSERT INTO pharmacy_payment_acceptance (pharmacy_id, accepts_afya_points, accepts_labor_hours, max_afya_points_per_order, min_fiat_percentage)
...
INSERT INTO facility_payment_acceptance (facility_id, accepts_afya_points, accepts_labor_hours, max_afya_points_per_service, min_fiat_percentage)
...
CREATE TABLE IF NOT EXISTS hybrid_payment_approval_queue (
  ...
  expires_at TIMESTAMP DEFAULT (CURRENT_TIMESTAMP + INTERVAL '24 hours'), -- Auto-reject after 24 hours
...
BEGIN
  INSERT INTO hybrid_payment_approval_queue (
    unified_payment_id,
    transaction_type,
    transaction_id,
    approver_type,
