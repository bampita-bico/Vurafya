...
CREATE TABLE IF NOT EXISTS labor_services_registry (
  ...
  hourly_rate_ugx DOUBLE PRECISION, -- Converted to UGX for display
  ...
  reliability_score DOUBLE PRECISION DEFAULT 0.5, -- 0.0-1.0 (shows up on time, completes work)
...
CREATE TABLE IF NOT EXISTS labor_skill_categories (
  ...
  base_hourly_rate_ugx DOUBLE PRECISION NOT NULL, -- Base rate in UGX
  demand_level VARCHAR(40) DEFAULT 'medium', -- low / medium / high / very_high
  demand_multiplier DOUBLE PRECISION DEFAULT 1.0, -- Surge pricing for high-demand skills
  description TEXT,
...
INSERT INTO labor_skill_categories (category_name, base_hourly_rate_ap, base_hourly_rate_ugx, demand_level, demand_multiplier, description, required_certification, physical_intensity, skill_tier) VALUES
...
CREATE TABLE IF NOT EXISTS labor_booking_requests (
  ...
  -- Platform Revenue
  transaction_fee_pct DOUBLE PRECISION DEFAULT 5.0, -- 5% fee on labor transactions
