...
CREATE TABLE review_decision_factors (
    ...
    factor_weight DOUBLE PRECISION DEFAULT 1.0,  -- Importance of this factor
...
-- INSERT INTO review_decision_factors (review_history_id, submission_type, submission_id, factor_category, factor_name, factor_status, factor_notes) VALUES
...
-- INSERT INTO foods (name, local_name, category, energy_kcal, protein_g, ...)
...
-- INSERT INTO review_comments (submission_type, submission_id, review_queue_id, comment_by_user_id, comment_by_role, comment_text, comment_type, addressed_to_user_id, requires_response) VALUES
