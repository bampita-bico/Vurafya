...
CREATE TABLE IF NOT EXISTS currency_exchange_rates (
  ...
  exchange_rate DOUBLE PRECISION NOT NULL, -- How many 'to' units per 1 'from' unit (e.g., 1 UGX = 0.029 KES)
...
CREATE TABLE IF NOT EXISTS universal_currency_matrix (
  ...
  ugx_exchange_rate DOUBLE PRECISION NOT NULL, -- 1 unit of this currency = X UGX
...
INSERT INTO universal_currency_matrix (currency_type, currency_code, ugx_exchange_rate, is_base_currency) VALUES
('fiat', 'UGX', 1.0, TRUE);

-- Seed Afya Points conversion (1000 UGX = 10 AP, so 1 AP = 100 UGX)
INSERT INTO universal_currency_matrix (currency_type, currency_code, ugx_exchange_rate) VALUES
...
INSERT INTO currency_exchange_rates (from_currency_code, to_currency_code, exchange_rate, rate_source) VALUES
...
FOR EACH ROW
BEGIN
  INSERT INTO exchange_rate_history (from_currency_code, to_currency_code, exchange_rate, rate_source)
