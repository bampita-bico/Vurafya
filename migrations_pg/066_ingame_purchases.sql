...
CREATE TABLE avatar_cosmetic_shop (
    ...
    -- Discounts
    discount_pct DOUBLE PRECISION DEFAULT 0,  -- Current discount percentage
...
CREATE TABLE cosmetic_bundles (
    ...
    savings_pct DOUBLE PRECISION,  -- Discount percentage
...
INSERT INTO avatar_cosmetic_shop (cosmetic_id, price_afya_points, price_usd_cents, is_premium, min_level_required, min_evolution_stage)
VALUES
...
INSERT INTO avatar_cosmetic_shop (cosmetic_id, price_afya_points, price_usd_cents, is_premium, min_level_required, min_evolution_stage, requires_achievement_id)
VALUES
...
INSERT INTO cosmetic_earning_methods (cosmetic_id, earn_method, earn_requirement, required_level, difficulty_rating)
VALUES
...
INSERT INTO cosmetic_earning_methods (cosmetic_id, earn_method, earn_requirement, required_evolution_stage, difficulty_rating)
VALUES
...
INSERT INTO cosmetic_earning_methods (cosmetic_id, earn_method, earn_requirement, required_achievement_id, difficulty_rating)
VALUES
...
-- INSERT INTO user_purchase_history (user_id, cosmetic_id, purchase_method, amount_paid_ap, amount_paid_usd_cents)
-- VALUES (123, 20, 'achievement_unlock', 0, 0);
--
-- INSERT INTO user_cosmetics (user_id, cosmetic_id, unlocked_at, unlock_method)
...
--
-- INSERT INTO user_purchase_history (user_id, cosmetic_id, purchase_method, amount_paid_ap)
...
--
-- INSERT INTO user_purchase_history (user_id, cosmetic_id, purchase_method, amount_paid_usd_cents, payment_processor, payment_transaction_id, payment_status)
