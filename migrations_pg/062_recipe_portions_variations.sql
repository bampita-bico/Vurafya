...
ALTER TABLE recipes ADD COLUMN calories_per_serving DOUBLE PRECISION;
...
ALTER TABLE recipes ADD COLUMN protein_g_per_serving DOUBLE PRECISION;
ALTER TABLE recipes ADD COLUMN carbs_g_per_serving DOUBLE PRECISION;
ALTER TABLE recipes ADD COLUMN fat_g_per_serving DOUBLE PRECISION;
ALTER TABLE recipes ADD COLUMN fiber_g_per_serving DOUBLE PRECISION;
ALTER TABLE recipes ADD COLUMN sodium_mg_per_serving DOUBLE PRECISION;
ALTER TABLE recipes ADD COLUMN potassium_mg_per_serving DOUBLE PRECISION;
...
CREATE TABLE recipe_variations (
    ...
    calories_adjustment_pct DOUBLE PRECISION DEFAULT 0.0,  -- +/- percentage
    fat_adjustment_pct DOUBLE PRECISION DEFAULT 0.0,
    sodium_adjustment_pct DOUBLE PRECISION DEFAULT 0.0,
    fiber_adjustment_pct DOUBLE PRECISION DEFAULT 0.0,
...
-- Meal Type Tags
INSERT INTO recipe_tags (tag_name, tag_category) VALUES
('Breakfast', 'meal_type'),
('Lunch', 'meal_type'),
('Dinner', 'meal_type'),
('Snack', 'meal_type'),
...
-- INSERT INTO recipes (name, description, default_servings, prep_time_minutes, cook_time_minutes, difficulty_level, cuisine_type, region, is_ckd_friendly, is_diabetic_friendly, is_heart_healthy, is_vegetarian, is_vegan)
-- VALUES
...
-- INSERT INTO recipe_variations (base_recipe_id, variation_name, cooking_method_id, calories_adjustment_pct, health_rating, health_comparison, variation_notes, why_choose_this)
-- VALUES
...
-- INSERT INTO recipe_variations (base_recipe_id, variation_name, cooking_method_id, calories_adjustment_pct, fat_adjustment_pct, health_rating, health_comparison, variation_notes, why_choose_this)
-- VALUES
...
-- INSERT INTO meals (user_id, meal_source, recipe_id, portion_size_pct, meal_time)
