...
-- Not just XP - requires DOUBLE PRECISION health metrics improvements
...
CREATE TABLE avatar_evolution_stages (
    ...
    min_medication_adherence_pct DOUBLE PRECISION DEFAULT 0,  -- Overall adherence % since diagnosis
...
INSERT INTO avatar_evolution_stages VALUES
(1, 1, 'Beginner', 1,
    0, 0, 0, 0, 0,
    0, 0, 0,
...
CREATE TABLE avatar_health_milestones (
    ...
    baseline_value DOUBLE PRECISION,  -- Starting value
    achieved_value DOUBLE PRECISION,  -- Current value
...
CREATE TABLE avatar_evolution_progress (
    ...
    medication_adherence_pct DOUBLE PRECISION DEFAULT 0,
    ...
    hba1c_progress_pct DOUBLE PRECISION DEFAULT 0,
    bp_progress_pct DOUBLE PRECISION DEFAULT 0,
    meal_logging_progress_pct DOUBLE PRECISION DEFAULT 0,
    adherence_progress_pct DOUBLE PRECISION DEFAULT 0,
    overall_progress_pct DOUBLE PRECISION DEFAULT 0,
...
--   - INSERT INTO avatar_health_milestones (milestone_type='adherence_streak', milestone_name='7-day meal logging streak', xp_awarded=100)
--   - UPDATE avatar_stats SET adherence_based_xp += 100, total_xp_earned += 100
--
-- IF hba1c improved ≥0.5% since last test:
--   - INSERT INTO avatar_health_milestones (milestone_type='lab_improvement', milestone_name='HbA1c drops 0.5%', xp_awarded=200, baseline_value=8.2, achieved_value=7.7, improvement_pct=6.1)
...
--     * INSERT INTO avatar_health_milestones (milestone_type='evolution', evolution_stage_unlocked=new_stage, xp_awarded=1000)
...
-- - INSERT INTO avatar_appearance_history
