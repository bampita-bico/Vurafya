...
CREATE TABLE biomarker_reference_ranges (
    ...
    critical_low DOUBLE PRECISION,  -- Below this = life-threatening emergency
    low_threshold DOUBLE PRECISION,  -- Below this = abnormally low, needs intervention
    normal_min DOUBLE PRECISION,  -- Lower bound of normal range
    normal_max DOUBLE PRECISION,  -- Upper bound of normal range
    high_threshold DOUBLE PRECISION,  -- Above this = abnormally high, needs intervention
    critical_high DOUBLE PRECISION,  -- Above this = life-threatening emergency
...
INSERT INTO biomarker_reference_ranges VALUES
