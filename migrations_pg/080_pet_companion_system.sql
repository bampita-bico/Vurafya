...
INSERT INTO pet_species (id, species_name, display_name, description, native_region, base_happiness, base_health, condition_affinity, special_ability_description, requires_subscription_tier, icon) VALUES
...
-- Afya Owl evolution
INSERT INTO pet_evolution_stages (species_id, stage_name, stage_level, required_owner_streak, required_owner_level, required_pet_happiness, appearance_description, stat_bonus_type, stat_bonus_value, unlock_message) VALUES
...
INSERT INTO pet_care_actions (action_name, action_type, trigger_event, happiness_change, health_change, hunger_change, xp_reward, description, cooldown_hours) VALUES
...
INSERT INTO pet_abilities (species_id, stage_level, ability_name, ability_type, ability_value, description) VALUES
...
INSERT INTO pet_decay_rules (decay_trigger, happiness_decay, health_decay, hunger_decay, decay_interval_hours, recovery_action, warning_message) VALUES
