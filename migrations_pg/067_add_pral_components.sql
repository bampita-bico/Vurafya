...
ALTER TABLE renal_acid_load_data ADD COLUMN magnesium_mg DOUBLE PRECISION;
ALTER TABLE renal_acid_load_data ADD COLUMN calcium_mg DOUBLE PRECISION;
...
ALTER TABLE renal_acid_load_data ADD COLUMN pral_calculated DOUBLE PRECISION;  -- Auto-calculated from components
ALTER TABLE renal_acid_load_data ADD COLUMN pral_difference DOUBLE PRECISION;  -- pral_calculated - pral_value (for quality check)
