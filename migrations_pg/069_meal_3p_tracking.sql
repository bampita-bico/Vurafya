...
ALTER TABLE meal_nutrition_calculations ADD COLUMN protein_g_total DOUBLE PRECISION;
ALTER TABLE meal_nutrition_calculations ADD COLUMN potassium_mg_total DOUBLE PRECISION;
ALTER TABLE meal_nutrition_calculations ADD COLUMN phosphorus_mg_total DOUBLE PRECISION;
...
ALTER TABLE meal_nutrition_calculations ADD COLUMN pral_value DOUBLE PRECISION;
...
ALTER TABLE meal_nutrition_calculations ADD COLUMN magnesium_mg_total DOUBLE PRECISION;
ALTER TABLE meal_nutrition_calculations ADD COLUMN calcium_mg_total DOUBLE PRECISION;
