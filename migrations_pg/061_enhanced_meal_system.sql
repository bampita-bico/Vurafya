...
ALTER TABLE meals ADD COLUMN portion_size_pct DOUBLE PRECISION DEFAULT 100.0;
...
-- INSERT INTO meal_logging_requirements
...
CREATE TABLE meal_logging_compliance (
    ...
    compliance_pct DOUBLE PRECISION,  -- (meals_logged / meals_required) × 100

    -- Gap analysis
    longest_gap_hours DOUBLE PRECISION,  -- Longest time between consecutive meals
...
CREATE TABLE meal_portion_adjustments (
    ...
    standard_portion_grams DOUBLE PRECISION,
    actual_portion_grams DOUBLE PRECISION,
    portion_multiplier DOUBLE PRECISION,  -- actual / standard
...
-- INSERT INTO meal_portion_adjustments (meal_id, portion_multiplier, adjustment_reason)
-- VALUES (meal_id, 0.5, 'appetite_low');

-- METHOD 2: CUSTOM MEAL LOGGING
-- User creates ad-hoc meal: "Leftovers from yesterday"
-- INSERT INTO meals (user_id, meal_source, meal_name, meal_time)
-- VALUES (123, 'custom', 'Leftovers', '2026-04-12 19:00:00');
--
-- Then add components:
-- INSERT INTO meal_components (meal_id, food_id, quantity_grams)
-- VALUES
...
-- INSERT INTO meals (user_id, meal_source, meal_type, meal_time)
...
--   - INSERT INTO meal_logging_warnings
...
-- DOUBLE PRECISION-TIME CHECKING:
