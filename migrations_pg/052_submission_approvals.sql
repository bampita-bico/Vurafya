...
CREATE TABLE submission_approvals (
    ...
    overall_quality_score DOUBLE PRECISION,  -- Weighted average
...
CREATE TABLE approved_content_audit (
    ...
    -- User feedback
    user_rating_avg DOUBLE PRECISION,  -- Average user rating (1-5 stars)
...
CREATE TABLE submission_rewards (
    ...
    bonus_xp_multiplier DOUBLE PRECISION DEFAULT 1.0,
...
INSERT INTO submission_rewards (submission_type, tier, tier_criteria, base_xp, base_afya_points, min_quality_rating) VALUES
...
-- INSERT INTO foods (name, local_name, category, region_code, is_local, is_verified, energy_kcal, protein_g, carbs_g, ...)
...
-- - XP transaction
-- INSERT INTO user_xp_transactions (user_id, xp_earning_rule_id, base_xp, total_xp, related_entity_type, related_entity_id, description)
...
-- INSERT INTO approved_content_audit (submission_approval_id, production_table, production_record_id, quality_status)
...
-- INSERT INTO medications (..., verification_status)
