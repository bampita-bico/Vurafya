...
INSERT INTO xp_earning_rules VALUES
...
CREATE TABLE user_xp_transactions (
    ...
    quality_multiplier DOUBLE PRECISION DEFAULT 1.0,
    difficulty_multiplier DOUBLE PRECISION DEFAULT 1.0,
    total_multiplier DOUBLE PRECISION DEFAULT 1.0,  -- Product of all multipliers
...
CREATE TABLE daily_xp_summary (
    ...
    highest_multiplier DOUBLE PRECISION DEFAULT 1.0,
...
--
-- STEP 6: Award XP
-- INSERT INTO user_xp_transactions (user_id, xp_earning_rule_id, base_xp, streak_multiplier, quality_multiplier, total_multiplier, total_xp, related_entity_type, related_entity_id, description)
...
-- INSERT INTO xp_multiplier_context (xp_transaction_id, streak_days, streak_type, data_quality_score)
