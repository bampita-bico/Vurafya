...
-- INSERT INTO revision_requirements_tracking (submission_type, submission_id, review_history_id, requirement_number, requirement_description, requirement_category, is_mandatory, priority) VALUES
...
-- INSERT INTO submission_resubmissions (
...
-- INSERT INTO submission_version_history (submission_type, submission_id, version_number, previous_version_id, submission_data_json, version_type, changed_by_user_id)
-- SELECT
...
-- - Approves: INSERT INTO submission_review_history (...) with action_type='approved', decision='approve'
