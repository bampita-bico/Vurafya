...
CREATE TABLE IF NOT EXISTS consultation_bookings (
    ...
    -- Fee breakdown
    consultation_fee_ugx REAL NOT NULL,
    consultation_fee_usd REAL,
    currency_code VARCHAR(10) DEFAULT 'UGX',
    platform_commission_pct REAL NOT NULL,
    platform_commission_ugx REAL NOT NULL,
    doctor_payout_ugx REAL NOT NULL,
    tax_ugx REAL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS consultation_receipts (
    ...
    -- Amounts
    gross_amount_ugx REAL NOT NULL,
    gross_amount_usd REAL,
    currency_code VARCHAR(10) DEFAULT 'UGX',
    platform_fee_ugx REAL NOT NULL DEFAULT 0,
    platform_fee_pct REAL,
    provider_payout_ugx REAL DEFAULT 0,
    tax_ugx REAL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS referral_transactions (
    ...
    -- Fee breakdown
    referral_fee_ugx REAL DEFAULT 0,
    platform_cut_ugx REAL DEFAULT 0,
    referring_doctor_cut_ugx REAL DEFAULT 0,
...
INSERT OR IGNORE INTO referral_commission_rules (referral_type, total_referral_fee_pct, platform_share_pct, referring_share_pct, description) VALUES
...
INSERT OR IGNORE INTO fee_structure_config (fee_type, base_fee_pct, platform_share_pct, partner_share_pct, worker_share_pct, applies_to, charge_method, description, is_active, created_at, updated_at) VALUES
