...
CREATE TABLE reviewer_workload (
    ...
    current_utilization_pct REAL DEFAULT 0,  -- (total_active / max_concurrent) × 100
...
INSERT OR IGNORE INTO review_sla_targets (submission_type, priority_1_hours, priority_2_hours, priority_3_hours, priority_4_hours, priority_5_hours, escalation_threshold_hours, max_escalations) VALUES
...
CREATE TABLE auto_assignment_rules (
    ...
    max_workload_pct REAL DEFAULT 80,  -- Don't assign if reviewer >80% capacity
...
INSERT OR IGNORE INTO auto_assignment_rules VALUES
...
-- INSERT OR IGNORE INTO food_submissions (...) → food_submission_id = 123
--
...
--
-- STEP 2: Add to queue
-- INSERT OR IGNORE INTO submission_review_queue (
