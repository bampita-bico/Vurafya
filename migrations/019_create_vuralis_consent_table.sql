...
BEGIN
  INSERT OR IGNORE INTO vuralis_consent_log (user_id, consent_given, consented_at, revoked_at)
  VALUES (
    NEW.user_id,
...
INSERT OR IGNORE INTO vuralis_consent_policy (version, policy_text, effective_date) VALUES
