...
ALTER TABLE countries_supported ADD COLUMN inflation_rate_pct REAL; -- Annual inflation rate for pricing adjustments
...
INSERT OR IGNORE INTO countries_supported (country_code, country_name, currency_code, currency_symbol, region, language_primary, language_secondary, mobile_money_code, population_millions, accepts_barter, accepts_labor, inflation_rate_pct, regulatory_body) VALUES
