...
INSERT OR IGNORE INTO daily_login_calendar (day_number, reward_type, reward_value, reward_description, subscriber_multiplier, subscriber_bonus_type, subscriber_bonus_value, subscriber_bonus_description, is_milestone_day, icon) VALUES
...
INSERT OR IGNORE INTO login_streak_milestones (streak_days, milestone_name, reward_type, reward_value, subscriber_reward_type, subscriber_reward_value, title_reward, description) VALUES
