...
CREATE TABLE nutrient_targets (
    ...
    -- Target range
    target_min REAL,  -- Minimum daily intake
    target_max REAL,  -- Maximum daily intake
    target_value REAL, -- Point target (e.g. for views)
...
INSERT OR IGNORE INTO condition_nutrient_templates VALUES
...
--   * INSERT OR IGNORE INTO nutrient_targets (user_id, nutrient_id, target_min, target_max, reason, set_by)
--
