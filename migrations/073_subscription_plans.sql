...
ALTER TABLE subscription_plans ADD COLUMN price_monthly_usd REAL DEFAULT 0.0;
ALTER TABLE subscription_plans ADD COLUMN price_annual_usd REAL DEFAULT 0.0;
...
INSERT OR IGNORE INTO subscription_plans (id, plan_name, description, price_monthly_ugx, price_annual_ugx, price_monthly_usd, price_annual_usd, tier, features, max_consultations, ai_features_enabled, lab_discounts_pct, pharmacy_discounts_pct, trial_days, badge_label, color_hex, sort_order, is_active, created_at)
VALUES
(1, 'Afya Free',
...
INSERT OR IGNORE INTO subscription_features (feature_key, feature_name, category, required_tier, free_limit, plus_limit, pro_limit, description) VALUES
-- NUTRITION FEATURES
