...
CREATE TABLE IF NOT EXISTS barter_goods_catalog (
  ...
  estimated_value_ugx REAL, -- User's own estimate
...
CREATE TABLE IF NOT EXISTS barter_services_catalog (
  ...
  duration_hours REAL, -- How long the service takes
  ...
  -- Ratings
  rating_avg REAL DEFAULT 0, -- Average rating from past exchanges
...
INSERT OR IGNORE INTO barter_item_categories (category_name, category_type) VALUES
-- Goods
