...
CREATE TABLE IF NOT EXISTS ingredient_substitutions (
    ...
    substitution_ratio REAL DEFAULT 1.0, -- 1.0 = 1:1 replacement
...
CREATE TABLE IF NOT EXISTS risk_prediction_logs (
    ...
    risk_score REAL NOT NULL,      -- 0.0-1.0 probability
...
CREATE TABLE IF NOT EXISTS health_assessments (
    ...
    overall_health_score REAL,     -- 0-100
...
CREATE TABLE IF NOT EXISTS user_wellness_score (
    ...
    overall_score REAL NOT NULL,   -- 0.0-1.0 or 0-100
    nutrition_score REAL,
    physical_activity_score REAL,
    sleep_score REAL,
    mental_health_score REAL,
