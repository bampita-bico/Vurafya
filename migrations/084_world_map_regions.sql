...
CREATE TABLE IF NOT EXISTS region_content (
    ...
    description TEXT,
    unlock_at_exploration_pct REAL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS user_region_progress (
    ...
    exploration_pct REAL DEFAULT 0,
        -- 0-100%
...
INSERT OR IGNORE INTO world_map_regions (id, region_name, region_subtitle, description, lore_text, theme, min_level, max_level, requires_subscription_tier, condition_focus, color_hex, icon, map_position_x, map_position_y, ambient_description, total_quests_available, total_bosses_available) VALUES
...
INSERT OR IGNORE INTO region_unlock_requirements (region_id, requirement_type, requirement_key, requirement_value, requirement_text) VALUES
...
INSERT OR IGNORE INTO region_unlock_requirements (region_id, requirement_type, requirement_key, requirement_value, requirement_text, is_mandatory) VALUES
...
INSERT OR IGNORE INTO region_content (region_id, content_type, content_id, content_name, description, unlock_at_exploration_pct) VALUES
