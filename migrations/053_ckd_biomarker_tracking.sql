...
CREATE TABLE creatinine_egfr_logs (
    ...
    egfr_ml_min REAL,  -- Estimated glomerular filtration rate
    ...
    bun_mg_dl REAL,  -- Blood Urea Nitrogen (normal: 7-20 mg/dL)
    urine_albumin_mg REAL,  -- Albumin in urine (marker of kidney damage)
...
CREATE TABLE phosphorus_logs (
    ...
    calcium_mg_dl REAL,  -- Calcium (inverse relationship with phosphorus)
    pth_pg_ml REAL,  -- Parathyroid hormone (regulates phosphorus)
    vitamin_d_ng_ml REAL,  -- Vitamin D (affects phosphorus absorption)
